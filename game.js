...
const gameBoard = (function () {
  ...
  const whoPlaysNow = () => {
    if (gameBoard.games % 2 == 0 && gameBoard.moves % 2 == 0) {
      //even games and even moves
      return "x";
    } else if (gameBoard.games % 2 == 0 && gameBoard.moves % 2) {
      // even games and odd moves
      return "o";
    } else if (gameBoard.games % 2 && gameBoard.moves % 2 == 0) {
      //odd games and even moves
      return "o";
    } else if (gameBoard.games % 2 && gameBoard.moves % 2) {
      // odd games and odd moves
      return "x";
    }
  };
      ...
      horizontalChecker ||=
        ...
        gameBoard.board[rowIndex] != undefined
          ? //return true to check and mark the line
            ...
            howWins(gameBoard.board[rowIndex]),
            true)
          : false;
    }
